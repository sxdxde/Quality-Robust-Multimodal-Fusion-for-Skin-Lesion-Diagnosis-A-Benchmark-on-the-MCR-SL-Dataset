...
Eleven follow-up configurations have been evaluated. Sharpness-aware minimization with test-time augmentation has reached 0.822, the best of this sweep. Contrastive pretraining, the alternative optimizer, and quality-aware training have each underperformed the baseline, a convergent negative result across three independent interventions, and stacking every promising intervention together has underperformed both the baseline and its components, 0.759 against 0.783 and 0.822.
