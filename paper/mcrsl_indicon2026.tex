...
To the authors' knowledge, no prior work has used a direct expert rating of image quality as a loss-reweighting signal in medical image classification. Existing quality-aware objectives rely on estimated proxies such as the feature norm \cite{adaface,magface}; the closest medical quality-aware method acts on the architecture and on predicted quality \cite{qgdr}; and the closest loss-weighting scheme on skin lesions derives sample difficulty from the model rather than from an expert rating of the image \cite{hu2023}. This paper has addressed that gap directly.
